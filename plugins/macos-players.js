(function () {
    ...
    function startPlugin() {
        ...
        console.log('[macOS Players] Plugin loaded v1.0.2');
        ...
        // Добавляем поле для кастомной схемы в настройки
        try {
        ...
        Lampa.Player.play = function(data) {
            ...
            console.log('[macOS Players] Selected player:', selectedPlayer);
        ...
        function handleExternalPlayer(data, playerType) {
            ...
            if (playerType === 'movist') {
                ...
                if (!scheme) {
                    Lampa.Noty.show('Configure custom player scheme in settings');
                    return;
                }
